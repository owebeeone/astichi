...
| **expr** | scalar expression hole + single insert; dict initializer `**` expansion with dict payloads; scalar dict-key replacement | [expr/scalar_hole/](snippets/expr/scalar_hole/), [expr/dict_expansion/](snippets/expr/dict_expansion/) | [scalar_hole_generated.py](snippets/expr/scalar_hole/scalar_hole_generated.py), [dict_expansion_generated.py](snippets/expr/dict_expansion/dict_expansion_generated.py) |
