...
def test_build_preserves_dstar_kwargs_hole_anchor_multiple_ordered_inserts() -> None:
    ...
    b = astichi.build()
    b.add.Root(root)
    b.add.Pa(_compile('astichi_funcargs(a=astichi_pass(ctxt, outer_bind=True)["a"])'))
    b.add.Pb(_compile('astichi_funcargs(b=astichi_pass(ctxt, outer_bind=True)["b"])'))
    b.add.Pc(_compile('astichi_funcargs(c=astichi_pass(ctxt, outer_bind=True)["c"])'))
    b.Root.kwargs.add.Pa(order=0)
...
def test_build_preserves_star_args_hole_anchor_multiple_ordered_inserts() -> None:
    ...
    b = astichi.build()
    b.add.Root(root)
    b.add.Pa(_compile('astichi_funcargs(astichi_pass(ctxt, outer_bind=True)["a"])'))
    b.add.Pb(_compile('astichi_funcargs(astichi_pass(ctxt, outer_bind=True)["b"])'))
